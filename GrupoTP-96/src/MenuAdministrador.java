...
public class MenuAdministrador {
    ...
    public MenuAdministrador(Store store) {
    ...
    public void exibirMenuAdministrador() {
        ...
        do {
            ...
            System.out.println("3. Listar as atividades existentes");
            System.out.println("4. Listar os utilizadores registrados\n");
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    System.out.print("\nA atividade foi adicionado com sucesso!");

                    break;
                case 3:
                    this.store.imprimirStoreAtividades(this.store.getStoreAtividades());
                    break;
                case 4:
                    this.store.imprimirStoreUtilizadores(this.store.getStoreUtilizadores());
                    break;
                case 0:
                    break;
                default:
